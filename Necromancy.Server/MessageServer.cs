...
namespace Necromancy.Server
{
    ...
    /// 0x482
    /// 0x482 - (0x6FF) = 0x6FF
    /// 0x482 - (0x6FF + 0x64) = 0x763
    /// 0x482 - (0x6FF + 0x64 + 0x370) = 0xAD3
    ///
    /// 0x482 - (0x19C) = 0x19C
    ...
    /// 0x9D6A - (0x9DE2 + 0x67) = 0x9E49
    /// 0x9D6A - (0x9DE2 + 0x67 + 0x29F) = 0xA0E8
    ///
    /// 0x95E6
    ...
    /// 0x8D24 - (0x8D3A + 0x18) = 0x8D52
    /// 0x8D24 - (0x8D3A + 0x18 + 0x22) = 0x8D74
    ///
    /// 0x64B5
    /// 0x55FF
    /// 0x5315
    ...
    /// 0x7DB1 - (0x7A60 + 0x69) = 0x7AC9
    /// 0x7DB1 - (0x7A60 + 0x69 + 0x177) = 0x7C40
    ///
    ...
    /// 0x3784 - (0x31B4 + 0x146) = 0x32FA
    /// 0x3784 - (0x31B4 + 0x146 + 0x16) = 0x3310
    ///
    /// 0x392F
    /// 0x3B93
    ///
    ...
    /// 0x1688 (0x1817 + 0x14) = 0x182B
    /// 0x1688 (0x1817 + 0x14 + 0x10A) = 0x1935 network::proto_msg_implement_client::recv_union_request_news_r 00 00 00 00 00 00 00 00
    /// 0xC87
    /// 0xE51
    /// 0x1421
    ///
