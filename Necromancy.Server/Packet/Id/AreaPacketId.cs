...
namespace Necromancy.Server.Packet.Id
{
    ...
    public enum AreaPacketId : ushort
    {
      ...
      /*send_party_invite =
        send_party_invite =
        send_party_establish =
        send_party_establish =
        send_auction_bid =
        send_auction_cancel_bid =
        send_auction_cancel_exhibit =
        send_auction_close =
        send_auction_exhibit =
        send_auction_re_exhibit =
        send_auction_receive_gold =
        send_auction_receive_item =
        send_auction_search =
        send_base_check_version =
        send_base_enter =
        send_battle_attack_exec =
        send_battle_attack_exec_direct =
        send_battle_attack_next =
        send_battle_attack_pose =
        send_battle_attack_start =
        send_battle_charge_end =
        send_battle_charge_start =
        send_battle_guard_end =
        send_battle_guard_start =
        send_battle_release_attack_pose =
        send_blacklist_clear =
        send_blacklist_close =
        send_blacklist_lock =
        send_blacklist_open =
        send_blacklist_unlock =
        send_buff_request_detach =
        send_buff_shop_buy =
        send_cash_shop2_buy =
        send_cash_shop_buy =
        send_cash_shop_check_billing_zip =
        send_cash_shop_fitting_equip =
        send_cash_shop_fitting_unequip =
        send_cash_shop_get_current_cash =
        send_cash_shop_get_url_common =
        send_cash_shop_get_url_common_steam =
        send_cash_shop_open_by_menu =
        send_cash_shop_regist_billing_zip =
        send_chara_pose =
        send_chara_pose_ladder =
        send_chara_view_landing =
        send_charabody_access_abort =
        send_charabody_access_start =
        send_charabody_loot_complete2 =
        send_charabody_loot_complete3 =
        send_charabody_loot_start2 =
        send_charabody_loot_start2_cancel =
        send_charabody_loot_start3 =
        send_charabody_salvage_abort =
        send_charabody_salvage_request =
        send_charabody_salvage_request_cancel =
        send_charabody_self_salvage_abort =
        send_charabody_self_salvage_notify_r =
        send_chat_post_message =
        send_check_job_change =
        send_cmd_exec =
        send_comment_set =
        send_comment_switch =
        send_create_package =
        send_data_get_self_chara_data_request =
        send_dbg_select_raise =
        send_door_open =
        send_emotion_update_type =
        send_equip_honor =
        send_event_abort =
        send_event_access_object =
        send_event_quest_get_order_list =
        send_event_quest_order_list_end =
        send_event_quest_order_r =
        send_event_quest_order_select =
        send_event_quest_report_list_end =
        send_event_quest_report_r =
        send_event_quest_report_select =
        send_event_removetrap_end =
        send_event_removetrap_select =
        send_event_removetrap_skill =
        send_event_request_int_r =
        send_event_script_play_r =
        send_event_select_channel_r =
        send_event_select_exec_r =
        send_event_select_map_and_channel_r =
        send_event_soul_rankup_close =
        send_event_soul_storage_close =
        send_event_sync_r =
        send_event_system_message_timer_r =
        send_event_tresurebox_end =
        send_event_tresurebox_select =
        send_event_union_storage_close =
        send_forge_check =
        send_forge_execute =
        send_forge_sp_check =
        send_forge_sp_execute =
        send_gamepot_web_close =
        send_gem_break =
        send_gem_break_cost =
        send_gem_cancel_piece =
        send_gem_cancel_support_item =
        send_gem_cancel_synthesis =
        send_gem_close =
        send_gem_rebuild =
        send_gem_set =
        send_gem_set_piece =
        send_gem_set_support_item =
        send_gem_set_synthesis =
        send_gem_synthesis =
        send_get_refusallist =
        send_gimmick_access_object =
        send_help_new_remove =
        send_inherit_start =
        send_item_drop =
        send_item_equip =
        send_item_move =
        ...
        send_item_unequip =
        send_item_use_item =
        send_item_use_object =
        send_job_change =
        send_job_change_close =
        send_job_change_select_bonuspoint =
        send_logout_cancel_request =
        send_logout_start_request =
        send_loot_access_object =
        send_map_change_force_r =
        send_map_enter =
        send_map_entry =
        send_map_get_info =
        send_message_board_close =
        send_package_all_delete =
        send_party_accept_to_apply =
        send_party_accept_to_invite =
        send_party_apply =
        send_party_cancel_member_recruit =
        send_party_cancel_party_recruit =
        send_party_change_leader =
        send_party_change_mode =
        send_party_decline_to_apply =
        send_party_decline_to_invite =
        send_party_disband =
        send_party_entry_draw =
        send_party_establish =
        send_party_invite =
        send_party_kick =
        send_party_leave =
        send_party_pass_draw =
        send_party_regist_member_recruit =
        send_party_regist_party_recruit =
        send_party_request_draw_item_list =
        send_party_search_recruited_member =
        send_party_search_recruited_party =
        send_quest_abort =
        send_quest_check_target =
        send_quest_check_time_limit =
        send_quest_display =
        send_quest_get_mission_quest_history =
        send_quest_get_mission_quest_works =
        send_quest_get_soul_mission_quest_history =
        send_quest_get_soul_mission_quest_works =
        send_quest_get_story_quest_history =
        send_quest_get_story_quest_works =
        send_quest_target_count =
        send_raisescale_add_item =
        send_raisescale_move_money =
        send_raisescale_open_cash_shop =
        send_raisescale_remove_item =
        send_raisescale_request_revive =
        send_raisescale_request_revive_event =
        send_raisescale_view_close_request =
        send_random_box_close =
        send_random_box_get_item =
        send_random_box_get_item_all =
        send_random_box_next_open =
        send_record_close =
        send_refusallist_add_user =
        send_return_home_request_exec =
        send_revive_execute =
        send_revive_init =
        send_select_package_update =
        send_shop_buy =
        send_shop_close =
        send_shop_identify =
        send_shop_repair =
        send_shop_sell =
        send_shop_sell_check =
        send_shortcut_request_data =
        send_shortcut_request_deregist =
        send_shortcut_request_regist =
        send_skill_cast_cancel_request =
        send_skill_combo_cast =
        send_skill_custom_close =
        send_skill_custom_slot_set =
        send_skill_exec =
        send_skill_next_cast =
        send_skill_onhit =
        send_skill_request_base_from_item =
        send_skill_request_gain =
        send_skill_request_info =
        send_skill_start_cast =
        send_skill_start_item_cast =
        send_soul_dispitem_request_data =
        send_soulmaterial_shop_buy =
        send_stall_buy_item =
        send_stall_close =
        send_stall_deregist_item =
        send_stall_open =
        send_stall_regist_item =
        send_stall_set_item_price =
        send_stall_set_name =
        send_stall_shopping_abort =
        send_stall_shopping_start =
        send_storage_deposit_item =
        send_storage_deposit_money =
        send_storage_draw_item =
        send_storage_draw_money =
        send_sv_conf_option_change =
        send_sv_conf_option_request =
        send_talkring_create_masterring =
        send_talkring_rename_masterring =
        send_temple_close =
        send_temple_cure_curse =
        send_trade_abort =
        send_trade_add_item =
        send_trade_fix =
        send_trade_invite =
        ...
        send_trade_reply =
        send_trade_revert =
        send_trade_set_money =
        send_union_close_window =
        send_union_mantle_close =
        send_union_rename_close =
        send_union_request_establish =
        send_union_request_rename =
        send_union_storage_deposit_money =
        send_union_storage_draw_money =
        send_union_storage_move_item =
        send_update_honor =
        send_wanted_entry =
        send_wanted_jail_close =
        send_wanted_jail_draw_point =
        send_wanted_jail_payment =
        send_wanted_list_close =
        send_party_establish =
        send_party_establish =
                */
    }
