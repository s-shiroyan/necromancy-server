...
namespace Necromancy.Server.Packet.Id
{
    ...
    ///                 
    /// 
    /// 0x5243 + 0xC4 - 0x004A7ED1 4 opocdes  [Complete]
    /// 
    ...
    ///
    /// 
    /// 0x4E17 + 0x76 - 0x004A732D 4 opcodes  [Complete]
    /// 
    ...
    ///                 
    ///                  
    /// 0x1F73 + 0xA9 - 0x0049CF7A 5 opcodes (1 no result?)  [Complete]
    /// 
    ...
    ///                 
    /// 
    /// 0x3B9F + 0xA2 - 0x004A40E1 4 opcodes (1 ret)  [Complete]
    /// 
    ...
    ///                 
    /// 
    /// 0x3247 + 0xA6 - 0x004A29D7 4 opcodes  [Complete]
    /// 
    ...
    ///                 
    ///                 
    /// 0x28E7 + 0xDE - 0x004A064B 4 opcodes (1 ret)  [Complete]
    /// 
    ...
    /// 
    /// 
    /// 0x2478 + 0x96 - 0x0049EE79 4 opcodes  [Complete]
    ///                 	
    ...
    ///                 
    /// 
    /// 0x18CC + 0xF7 - 0x0049B302 5 opcodes  [Complete]
    ///                 
    ...
    ///                 
    /// 
    /// 0x1E65 + 0xCD - 0x0049C989 4 opcodes  [Complete]
    /// 
    ...
    ///                 
    /// 
    /// 0x8CD  + 0xD0 - 0x004979DC 5 opcodes (1 ret)  [Complete]
    /// 
    ...
    public enum AreaPacketId : ushort
    {
        ...
        send_buff_shop_buy = 0x44, //opcode not found
        send_cash_shop2_buy = 0x45, //opcode not found
        send_cash_shop_buy = 0x46, //opcode not found
        ...
        send_equip_honor = 0x70, //opcode not found
        send_event_abort = 0x71, //opcode not found
        ...
        send_event_quest_order_r = 0x74, //opcode not found
        ...
        send_event_select_channel_r = 0x84, //opcode not found
        ...
        send_job_change_close = 0x122, //opcode not found
        ...
        send_party_invite = 0x141, //opcode not found
        ...
        send_party_regist_party_recruit = 0x148, //opcode not found
        ...
        send_skill_start_item_cast = 0x187, //opcode not found
        ...
        send_stall_close = 0x190, //opcode not found
        send_stall_deregist_item = 0xFC7D, 
        send_stall_open = 0x191, //opcode not found
        send_stall_regist_item = 0x192, //opcode not found
        send_stall_set_item_price = 0x193, //opcode not found
        send_stall_set_name = 0xB93, 
        send_stall_shopping_abort = 0x194,//opcode not found
        send_stall_shopping_start = 0x195, //opcode not found
        ...
        send_trade_revert = 0x211, //opcode not found
