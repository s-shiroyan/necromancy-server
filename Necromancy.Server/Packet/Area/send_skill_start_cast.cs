        ...
        public override void Handle(NecClient client, NecPacket packet)
        {
            ...
            Logger.Debug($"skillTarget [{skillTarget}]  skillID [{skillID}] skillLookup [{skillLookup}]");
            {
                var eventSwitchPerObjectID = new Dictionary<Func<int, bool>, Action>
                {
                        ...
                        { x => (x > 1 && x < 999999), () => SendSkillStartCastSelf(client, skillID, skillTarget, 0) } //this is a default catch statement for unmapped skills to prevent un-handled exceptions
                };
