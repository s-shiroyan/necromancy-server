...
{
    public class send_trade_reply : Handler
    {
        ...
        public override void Handle(NecClient client, NecPacket packet)
        {
            ...
            res.WriteInt32(0); 
            Router.Send(client.Map, (ushort) AreaPacketId.recv_trade_reply_r, res);
        ...
        private void SendTradeRepliedNotify(NecClient client)
        {
            ...
            Router.Send(client.Map, (ushort) AreaPacketId.recv_trade_notify_replied, res, client);
