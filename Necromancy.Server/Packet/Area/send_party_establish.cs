...
namespace Necromancy.Server.Packet.Area
{
    public class send_party_establish : ClientHandler
    {
        ...
        private void SendPartyNotifyEstablish(NecClient client, int partyType, int normItemDist, int rareItemDist,
            uint targetClientId, uint partyInstanceId)
        {
            if (targetClientId == 0)
            {
                targetClientId = client.Character.InstanceId;
            }
