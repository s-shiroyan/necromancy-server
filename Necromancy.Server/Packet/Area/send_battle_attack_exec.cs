...
namespace Necromancy.Server.Packet.Area
{
    public class send_battle_attack_exec : ClientHandler
    {
        ...
        private void SendReportNotifyHitEffect(NecClient client, IInstance instance)
        {
            ...
            Router.Send(client, (ushort)AreaPacketId.recv_battle_report_notify_hit_effect, res4, ServerType.Area);
        ...
        private void SendReportDamageHP(NecClient client, IInstance instance)
        {
            ...
            Router.Send(client, (ushort)AreaPacketId.recv_battle_report_notify_phy_damage_hp, res, ServerType.Area);
