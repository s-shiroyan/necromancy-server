...
.                       es_earring,
        ...
        private SpawnedItem MakeSpawnedItem(DbDataReader reader)
        {
            ...
            SpawnedItem spawnedItem = new SpawnedItem(spawnId, itemLocation);

            spawnedItem.BaseId = reader.GetInt32("base_id");
            ...
            spawnedItem.MaxSlots = reader.GetInt32("max_slots");
                        es_hand_r,
                        es_hand_,
                        es_quiver,
                        es_head,
